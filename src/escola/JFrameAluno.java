...
public class JFrameAluno extends javax.swing.JFrame {
    ...
    void createAluno() {
        try {
            ...
            ps.setString(1, jtxtnomeAluno.getText());
            ps.setString(2, jtxtcpfAluno.getText());
            ps.executeUpdate();
            carregarDados();
    ...
    void deleteAluno() {
        try {
            if (tabelaAluno.getSelectedRowCount() == 0) {
                ...
                ps = Persistencia.conexao().prepareStatement("DELETE FROM aluno WHERE idAluno=?");
    ...
    void updateAluno() {
        try {
            if (tabelaAluno.getSelectedRowCount() == 0) {
                ...
                ps = Persistencia.conexao().prepareStatement("UPDATE aluno SET nomeAluno=? WHERE idAluno=?");
